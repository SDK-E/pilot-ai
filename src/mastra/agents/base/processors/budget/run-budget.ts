...
function budgetFor(kind: ResearchKind): RunBudget {
  switch (kind) {
    case "direct-fact": {
      return {
        kind,
...
function serializeBudget(budget: RunBudget): string {
  return `
<research-budget>
...
export class RunBudgetProcessor implements Processor {
...
export const runBudgetProcessor = new RunBudgetProcessor();
