...
import { createMemoryResourceId } from "../../../contracts/conversation.js";
import {
  createPilotActivityReporter,
  runtimeSkillsEnabled,
} from "../../activity/reporter.js";
import { developmentAgentIdentity } from "../../development/identity.js";
import {
  createConversationMemory,
  createProjectMemory,
} from "../../memory/project-memory.js";
import { configureProductionTools } from "../../setup/production-tools.js";
import {
...
function createProductionToolAgent(
  ...
  const identity = isResearch ? developmentAgentIdentity : chatAgentIdentity;
...
export function createToolRuntime(
  ...
  configureProductionTools(storageConfig);
  ...
  return {
    async generate(rawCommand: unknown) {
      const command = (
        await import("../../../contracts/conversation.js")
