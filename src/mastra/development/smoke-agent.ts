...
export const developmentSmokeAgent = createBaseAgent({
  base: {
    maxSteps: 4,
    tokenLimit: 12_000,
    warningAt: 2,
  ...
  name: `${developmentAgentIdentity.name} Smoke`,
  ...
  instructions: [
    ...
    `
You are the fast smoke-test version of ${developmentAgentIdentity.name}.
