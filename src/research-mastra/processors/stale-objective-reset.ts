...
- preserve relevant tasks
- preserve relevant research state
...
- do not let stale research state bias the new task
- update Current Objective
- clear stale In Progress entries
- clear obsolete Pending entries
- clear obsolete Blocked entries
- clear obsolete Remaining Research
- clear obsolete Continuation Notes
...
For a new objective:
- do not continue tasks belonging only to the previous objective
- create a fresh task plan only when the new request is substantial
