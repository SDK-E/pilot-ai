...
export function createUrlFetchConfig(): UrlFetchConfig {
  return {
    ...
    getCachedValue: researchCache.getCachedValue.bind(researchCache),
    setCachedValue: researchCache.setCachedValue.bind(researchCache),
    makeCacheKey: researchCache.makeCacheKey.bind(researchCache),
  };
}
